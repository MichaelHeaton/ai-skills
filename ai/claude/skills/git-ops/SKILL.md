...
For branching rules, read `docs/guides/branching.md` in the ai-skills repo (or the copy under `~/.claude/skills/git-ops/` is not used — load from repo when this skill runs in ai-skills). Summary: always branch + PR/MR; no direct pushes to protected default branches.
