...
**Intermediate adapter:** [`aiwithremy/claude-skills-llm-council`](https://github.com/aiwithremy/claude-skills-llm-council)
...
GitHub issue [#103](https://github.com/MichaelHeaton/claude-skills/issues/103) tracks this upstream relationship.
