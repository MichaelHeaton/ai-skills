...
The repository is **under construction**. Present: `principles/`, `config/` templates, `categories/tags.yaml`, [docs/](docs/README.md). Skills and install tooling are not here yet — see [docs/ROADMAP.md](docs/ROADMAP.md).
